...
/// Intel Proprietary
///
/// This block implements the mask initialization for ALU input data Hamming code generation.
///
///=====================================================================================================================

///=====================================================================================================================
///                              init_mask_in Module Instantiation
///=====================================================================================================================

module init_mask_in (rstb, clk, en_init, mask);
...
///=====================================================================================================================
///                              init_mask_in Internal Signal Declarations
///=====================================================================================================================
	...
	always_ff @ (negedge rstb, posedge clk) begin	// data mask to generate Hamming code bit0
		if (!rstb) begin
	  		...
	  		if (en_init) begin
				...
				mask[0] <= sec_decode_64(seed0[width_data_sec-1:0]);
			end
		end
	end 
	...
	always_ff @ (negedge rstb, posedge clk) begin	// data mask to generate Hamming code bit1
		if (!rstb) begin
	  		...
	  		if (en_init) begin
				...
				mask[1] <= sec_decode_64(seed1[width_data_sec-1:0]);
			end
		end
	end
	...
	always_ff @ (negedge rstb, posedge clk) begin	// data mask to generate Hamming code bit2
		if (!rstb) begin
	  		...
	  		if (en_init) begin
				...
				mask[2] <= sec_decode_64(seed2[width_data_sec-1:0]);
			end
		end
	end
	...
	always_ff @ (negedge rstb, posedge clk) begin	// data mask to generate Hamming code bit3
		if (!rstb) begin
	  		...
	  		if (en_init) begin
				...
				mask[3] <= sec_decode_64(seed3[width_data_sec-1:0]);
			end
		end
	end
	...
	always_ff @ (negedge rstb, posedge clk) begin	// data mask to generate Hamming code bit4
		if (!rstb) begin
	  		...
	  		if (en_init) begin
				...
				mask[4] <= sec_decode_64(seed4[width_data_sec-1:0]);
			end
		end
	end
	...
	always_ff @ (negedge rstb, posedge clk) begin	// data mask to generate Hamming code bit5
		if (!rstb) begin
	  		...
	  		if (en_init) begin
				...
				mask[5] <= sec_decode_64(seed5[width_data_sec-1:0]);
			end
		end
	end
	...
	always_ff @ (negedge rstb, posedge clk) begin	// data mask to generate Hamming code bit6
		if (!rstb) begin
	  		...
	  		if (en_init) begin
				...
				mask[6] <= sec_decode_64(seed6[width_data_sec-1:0]);
			end
		end
	end
	
endmodule	// module init_mask_in
